            ...
            const response = await fetch(`https://server-5pxf.onrender.com/api/getcustomers/${customerId}`, {
              ...
              if (response.status === 401) {
                ...
                if (json.Success) {
                    ...
                    setcountryid(json.customer.countryid);
                    setstateid(json.customer.stateid);
                } else {
                    ...
                    <div className="col-lg-10 col-md-9 col-12 mx-auto">
                        ...
                        <form>
                            <div className="bg-white my-5 p-4 box mx-4">
                                ...
                                // countryid={customer.countryid != 0 && customer.countryid != "" && customer.countryid != null ? customer.countryid : 0}
