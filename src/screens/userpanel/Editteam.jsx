...
export default function Editteam() {
    ...
    const fetchteamData = async () => {
        try {
            ...
            const response = await fetch(`https://server-three-mu-70.vercel.app/api/getteamdata/${teamid}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://server-three-mu-70.vercel.app/api/updateteamdata/${teamid}`, {
                method: 'POST',
                headers: {
