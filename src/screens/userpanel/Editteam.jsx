...
export default function Editteam() {
    ...
    const fetchteamData = async () => {
        try {
            ...
            const response = await fetch(`https://server-chi-seven-94.vercel.app/api/getteamdata/${teamid}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://server-chi-seven-94.vercel.app/api/updateteamdata/${teamid}`, {
                method: 'POST',
                headers: {
                    ...
                    <div className="col-lg-10 col-md-9 col-12 mx-auto">
                        ...
                        <form>
                            <div className="bg-white my-5 p-4 box mx-4">
                                ...
                                <button type="button" className='btn btn-primary text-white me-2' onClick={handleSaveClick}>Save</button>
                            </div>
                        </form>
                    </div>
                </div>
