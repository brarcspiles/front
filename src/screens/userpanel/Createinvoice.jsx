...
export default function Createinvoice() {
    ...
    const fetchLastInvoiceNumber = async () => {
        try {
            ...
            const response = await fetch(`https://server-chi-seven-94.vercel.app/api/lastinvoicenumber/${userid}`, {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://server-chi-seven-94.vercel.app/api/savecreateinvoice', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': authToken,
