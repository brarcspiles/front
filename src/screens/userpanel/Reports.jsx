...
export default function Reports() {
    ...
    const fetchTotalReceivedAmount = async () => {
        try {
            ...
            const response = await fetch(`https://server-three-mu-70.vercel.app/api/currentMonthReceivedAmount2/${userid}?startOfMonth=${moment(startDate).format('YYYY-MM-DD')}&endOfMonth=${moment(endDate).format('YYYY-MM-DD')}`);
