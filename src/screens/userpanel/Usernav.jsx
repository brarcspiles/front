  ...
  <div class="">
    ...
    <div class="offcanvas offcanvas-start text-black" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <ul>
                    ...
                    {/* <li>
                      <Link to="/userpanel/E-Sign-Practice" className='nav-link scrollto icones text-black' >
                        <i class="fa-solid fa-house me-2 dashclr"></i> <span>E-Sign Practice</span>
                      </Link>
                    </li>
                    <li>
                      <Link to="/userpanel/Esignmodalpractice" className='nav-link scrollto icones text-black' >
                        <i class="fa-solid fa-house me-2 dashclr"></i> <span>Esignmodalpractice</span>
                      </Link>
                    </li> */}
                    <li>
