...
export default function Team() {
    ...
    const fetchdata = async () => {
        try {
            ...
            const response = await fetch(`https://server-chi-seven-94.vercel.app/api/teammemberdata/${userid}`, {
                headers: {
    ...
    const handleDeleteClick = async (teamid) => {
        try {
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://server-chi-seven-94.vercel.app/api/delteammember/${teamid}`, {
                method: 'GET',
                headers: {
                    Authorization: authToken,
                },
    ...
    const handleNextPage = () => {
        if ((currentPage + 1) * entriesPerPage < filteredTeamMembers.length) {
            setCurrentPage(currentPage + 1);
        }
    };
                            ...
                            <div className="bg-white my-5 p-4 box mx-4">
                                <div className="row py-2">
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-4 col-5 text-right">
                                        <button
                                            className="btn rounded-pill btn-danger text-white fw-bold"
                                                ...
                                                <tr key={team._id}>
                                                    ...
                                                    <td className="text-center">
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => navigate('/userpanel/TeamLocation', { state: { teamid: team._id } })}
                                                        >
                                ...
                                <div className="col-12 mt-3 d-flex justify-content-between">
                                    ...
                                    <button
                                        ...
                                        disabled={(currentPage + 1) * entriesPerPage >= filteredTeamMembers.length}
                                    >
                                        Next Page
                                    </button>
                                </div>
