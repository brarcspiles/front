        ...
        if (!sigCanvas.current.isEmpty()) {
            ...
            try {
                ...
                if (json.hasSignature) {
                    ...
                    const updateResponse = await fetch('https://server-three-mu-70.vercel.app/api/update-ownersignature', {
                        method: 'PUT',
                        headers: {
                    ...
                    const createResponse = await fetch('https://server-three-mu-70.vercel.app/api/ownersignature', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': localStorage.getItem('authToken'),
