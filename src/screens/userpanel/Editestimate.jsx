...
export default function Editestimate() {
    ...
    const fetchSignatureStatus = async () => {
        try {
            ...
            const response = await fetch(`https://server-chi-seven-94.vercel.app/api/check-signature/${ownerId}`);
    ...
    const saveSignature = async (signatureData) => {
        try {
            ...
            await fetch('https://server-chi-seven-94.vercel.app/api/ownersignature', {
                method: 'POST',
                headers: {
    ...
    const fetchdata = async () => {
        try {
            ...
            const response = await fetch(`https://server-chi-seven-94.vercel.app/api/geteditestimateData/${estimateid}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const response = await fetch(`https://server-chi-seven-94.vercel.app/api/updateestimateData/${estimateid}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': authToken,
    ...
    const handleDeleteClick = async (itemId) => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://server-chi-seven-94.vercel.app/api/delestimateitem/${estimateData._id}/${itemId}`, {
                method: 'GET',
                headers: {
                    'Authorization': authToken,
                  }
