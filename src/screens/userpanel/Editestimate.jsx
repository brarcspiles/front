...
export default function Editestimate() {
    ...
    const fetchdata = async () => {
        try {
            ...
            const response = await fetch(`https://server-three-mu-70.vercel.app/api/geteditestimateData/${estimateid}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const response = await fetch(`https://server-three-mu-70.vercel.app/api/updateestimateData/${estimateid}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': authToken,
    ...
    const handleDeleteClick = async (itemId) => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://server-three-mu-70.vercel.app/api/delestimateitem/${estimateData._id}/${itemId}`, {
                method: 'GET',
                headers: {
                    'Authorization': authToken,
                  }
