              ...
              <div className="sb-sidenav-menu">
                <div className="nav">
                  <ul>
                    ...
                    {/* <li>
                      <Link to="/userpanel/E-Sign-Practice" className='nav-link scrollto icones w-100 text-black' >
                        <img src={pin} width="24px" height='24px' /> <span className='ps-2'>E-Sign Practice</span>
                      </Link>
                    </li>
                    <li>
                      <Link to="/userpanel/Esignmodalpractice" className='nav-link scrollto icones w-100 text-black' >
                        <img src={pin} width="24px" height='24px' /> <span className='ps-2'>Esignmodalpractice</span>
                      </Link>
                    </li> */}
                    <li>
                    ...
                    <li>
                      <Link to="/conformityreport" className='nav-link scrollto w-100 icones text-black' >
                        <img src={customers} width="24px" height='24px' /> <span className='ps-2'>Conformity Report</span>
                      </Link>
                    </li>
