...
.text-end {
  ...
  const fetchinvoiceData = async () => {
    try {
      ...
      const response = await fetch(`https://server-three-mu-70.vercel.app/api/getemailinvoiceData/${invoiceId}`, {
        // headers: {
  ...
  const fetchsignupdata = async () => {
    try {
      ...
      // const userid =   localStorage.getItem("userid");
      // const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://server-three-mu-70.vercel.app/api/getemailsignupdata/${userId}`, {
        // headers: {
        //   'Authorization': authToken,
        // }
      });
  ...
  const fetchtransactiondata = async () => {
    try {
      // const userid = localStorage.getItem("userid");
      // const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://server-three-mu-70.vercel.app/api/getemailtransactiondata/${invoiceId}`, {
        // headers: {
        //   'Authorization': authToken,
        // }
      });
  ...
  const fetchOwnerData = async () => {
    try {
      ...
      // const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://server-three-mu-70.vercel.app/api/getemailownerdata/${ownerId}`, {
        // headers: {
        //   'Authorization': authToken,
        // }
      });
  ...
  const checkCustomerSignature = async (invoiceIdpass) => {
    ...
    try {
      const response = await fetch(`https://server-three-mu-70.vercel.app/api/checkcustomersignatureusinginvoice/${encodeURIComponent(invoiceIdpass)}`);
      const json = await response.json();
  ...
  const handleSignatureClick = async () => {
    ...
    try {
      ...
      const checkResponse = await fetch(`https://server-three-mu-70.vercel.app/api/checkcustomersignatureusinginvoice/${encodeURIComponent(invoiceData._id)}`);
      const checkJson = await checkResponse.json();
  
      if (checkJson.hasSignature) {
        // Update the existing customer signature
        const updateResponse = await fetch(`https://server-three-mu-70.vercel.app/api/updatecustomersigninv/${encodeURIComponent(invoiceData._id)}`, {
          method: 'PUT',
          headers: {
...
//     try {
//         const response = await fetch('https://server-three-mu-70.vercel.app/api/customersignature', {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/json',
//                 // 'Authorization': authToken,
...
// };
  ...
  const handleDocumentComplete = async () => {
    try {
      ...
      const emailResponse = await fetch('https://server-three-mu-70.vercel.app/api/send-Invoice-signed-email', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  //     // Send email request to backend
  //     const response = await fetch('https://server-three-mu-70.vercel.app/api/send-Invoice-signed-email', {
  //       method: 'POST',
  //       headers: {
  //         'Content-Type': 'application/json',
  //       },
