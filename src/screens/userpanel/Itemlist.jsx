...
export default function Itemlist() {
    ...
    const handleDeleteClick = async (itemId) => {
        try {
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://server-chi-seven-94.vercel.app/api/delitem/${itemId}`, {
                method: 'GET',
                headers: {
                    'Authorization': authToken,
                }
                    ...
                    <div className="bg-white my-5 p-4 box mx-4">
                        <div className='row py-2'>
                            ...
                            <div className="col-lg-3 col-md-4 col-sm-4 col-5 text-right">
                                <button className='btn rounded-pill btn-primary text-white fw-bold' onClick={handleAddClick}>+ Create</button>
                            </div>
                        </div><hr />
