    ...
    const handleClockIn = async () => {
        try {
          ...
          const authToken = localStorage.getItem('authToken');
            ...
            const response = await fetch('https://server-three-mu-70.vercel.app/api/clockin', {
              method: 'POST',
              headers: {
        ...
        const handleClockOut = async () => {
            try {
              ...
              let isTeamMember = localStorage.getItem('isTeamMember');
              const authToken = localStorage.getItem('authToken');
              const response = await fetch('https://server-three-mu-70.vercel.app/api/clockout', {
                method: 'POST',
                headers: {
                  'Content-Type': 'application/json',
                  'Authorization': authToken,
          ...
          const fetchUserEntries = async (start, end) => {
            try {
              const userid = localStorage.getItem('userid');
              const authToken = localStorage.getItem('authToken');
              const response = await fetch(`https://server-three-mu-70.vercel.app/api/userEntries/${userid}`, {
                headers: {
                  'Authorization': authToken,
                }
              });
