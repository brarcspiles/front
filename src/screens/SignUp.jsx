...
export default function SignUp() {
  ...
  const [addedCompanyPhotos, setCompanyAddedPhotos] = useState([]);
    ...
    const handleSubmit = async (e) => {
        ...
        // const companyUploadResponse = await fetch("https://server-5pxf.onrender.com/api/upload-image", {
        // method: 'POST',
        ...
        const response = await fetch("https://server-5pxf.onrender.com/api/createuser", {
          method: 'POST',
          headers: {
