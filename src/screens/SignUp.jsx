...
export default function SignUp() {
  ...
  const [addedCompanyPhotos, setCompanyAddedPhotos] = useState([]);
    ...
    const handleSubmit = async (e) => {
        ...
        // const companyUploadResponse = await fetch("https://server-chi-seven-94.vercel.app/api/upload-image", {
        // method: 'POST',
        ...
        const response = await fetch("https://server-chi-seven-94.vercel.app/api/createuser", {
          method: 'POST',
          headers: {
